...
App.Views.FirstPage = (function(superClass) {
  extend(FirstPage, superClass);

  function FirstPage(opts) {
    if (opts == null) {
      opts = {};
    }
  ...
  FirstPage.prototype._animate = function(top) {
...
App.Views.Footer = (function(superClass) {
  ...
  function Footer(opts) {
    ...
    Footer.__super__.constructor.call(this, opts);
  }
...
App.Views.LastPage = (function(superClass) {
  extend(LastPage, superClass);
  ...
  function LastPage(opts) {
    ...
    LastPage.__super__.constructor.call(this, opts);
    at = '@';
    this.contactEmail = 'hello' + at + 'artofcode' + '.' + 'co';
  }

  LastPage.prototype.render = function() {
    return this._renderContactEmail();
  };

  LastPage.prototype._renderContactEmail = function() {
    var b;
    b = baffle('#contact_email', {
      characters: '█▓▒░█▓▒░█▓▒░<>/',
      speed: 161
    });
    b.start();
